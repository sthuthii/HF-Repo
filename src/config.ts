...
export type RoleValue = string & { readonly __brand: Role };

/**
 * ROLE-SPECIFIC PATH PATTERNS
 */
export const ROLE_PATH_PATTERNS: Record<Role, string[]> = {
  [Role.FRONTEND]: [
 ...
 * FILE TYPE PATTERNS
 */
export const FILE_TYPE_ASSOCIATIONS: Record<string, Set<Role>> = {
  // Frontend
 ...
 */
export const MAX_DEPENDENCY_DEPTH = 2; // 1-2 hop graph traversal
export const MAX_FILES_PER_PRIORITY = 50; // Limit results to avoid overwhelming UI
...
export const ROLE_DESCRIPTIONS: Record<Role, string> = {
  [Role.FRONTEND]:
    "Frontend Developer - Focuses on UI components, styling, and user interactions",
  [Role.BACKEND]:
    "Backend Developer - Focuses on APIs, business logic, and data handling",
  [Role.FULL_STACK]:
    "Full Stack Developer - Balanced view of frontend and backend",
  [Role.DEVOPS]:
    "DevOps Engineer - Focuses on deployment, infrastructure, and CI/CD",
  [Role.AI_ML]:
    "AI/ML Engineer - Focuses on model training, inference, and ML pipelines",
  [Role.DATA]:
    "Data Engineer - Focuses on data pipelines, databases, and ETL",
  [Role.QA]:
    "QA/Test Engineer - Focuses on testing, automation, and quality assurance",
  [Role.SECURITY]:
    "Security Engineer - Focuses on authentication, encryption, and access control",
};
